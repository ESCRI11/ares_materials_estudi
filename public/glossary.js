...
const GLOSSARY = {
	...
	schema: "A written description of the shape data must have: which fields exist, what type each one holds, which are required, and for a fixed set of answers, the exact list of allowed values. Sent to a model, it is what makes structured output enforceable.",
