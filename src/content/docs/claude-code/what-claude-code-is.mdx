	...
	questions={[
		{
			...
			options: [
				...
				'Claude Code reads your project and edits the files on disk itself, rather than handing you text to copy back',
		...
		},
		{
			...
			options: [
				'Yes, with a lower message limit',
				'No — it requires a paid plan or a Console account with API credits',
				'Yes, but only the web version',
			],
			answer: 1,
			explanation:
		...
		},
		{
			...
			options: [
				'Because the test bans all software, including Claude Code',
				'Because code produced for you can pass an assignment while leaving you unable to write it yourself in an individual written test',
				'Because the course forbids students from using AI tools',
			],
			answer: 1,
			explanation:
