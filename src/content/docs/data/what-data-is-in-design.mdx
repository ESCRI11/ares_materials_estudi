...
their fields is the normal state of real data, and the next two lessons are about that.
...
only the middle: the file formats and the loops. Those are the two lessons that follow.
:::
...
<Quiz
	...
	questions={[
		...
		},
		{
			...
			options: [
				'Replaced weak qualitative data with strong quantitative data',
				'Turned qualitative data into quantitative by coding it, gaining comparison and losing what they actually said',
				'Nothing meaningful, because interviews cannot be counted',
			],
			answer: 1,
			explanation:
		...
		},
		{
			...
			options: [
				'Visualise — without it the data stays unreadable',
				'Define — without a written question you collect the wrong fields and later read meaning into whatever you happen to have',
				'Collect — most projects reuse someone else’s data anyway',
			],
			answer: 1,
			explanation:
