...
<Quiz
	...
	questions={[
		...
		},
		{
			...
			options: [
				'Co-design is research run with a larger and more representative sample',
				'In research people are a source; in co-design they make the thing',
				'Co-design replaces research, since participants know what they need',
			],
			answer: 1,
			explanation:
