...
<Quiz
	...
	questions={[
		...
		},
		{
			...
			options: [
				'A journey map is more detailed than a user flow of the same task',
				'A flow is one task in your system; a journey reaches outside it',
				'A user flow is drawn for developers and a journey map for clients',
			],
			answer: 1,
			explanation:
		...
		},
		{
			...
			options: [
				...
				'Delete the row until you have research that covers those stages',
				'Keep it, mark the cells as assumptions, and research them next',
			],
			answer: 2,
			explanation:
