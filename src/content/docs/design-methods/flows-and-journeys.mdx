...
```
  ...
  [ scan machine QR ]
       │
       ▼
   ◇ logged in? ◇ ── no ──▶ [ sign-in ] ──▶ (fail: no account) 
       │ yes
       ▼
   ◇ slot free? ◇ ── no ──▶ [ next free slot offered ] ──┐
       │ yes                                             │
       ▼                                                 ▼
  [ confirm booking ]  ◀──────────────────────────  ◇ accept? ◇ ── no ──▶ ( end: abandoned )
       │
       ▼
  ( end: booked )
```
...
```
  physical evidence   the sheet, the machine, the email, the room
  ─────────────────────────────────────────────────── line of interaction
  customer actions    what the person does
  ─────────────────────────────────────────────────── 
  front-stage         staff and interfaces the person can see
  ─────────────────────────────────────────────────── line of visibility
  back-stage          work done for this person that they never see
  ─────────────────────────────────────────────────── line of internal interaction
  support processes   systems, databases, suppliers, other departments
```
