	...
	questions={[
		{
			...
			options: [
				'Laser cutter, because it cuts plywood quickly',
				'3D printer, because the shape varies with height',
				'Vinyl cutter, because the bracket is a small part',
			],
			answer: 1,
			explanation:
		...
		},
		{
			...
			options: [
				'They remove material, so the tool must reach every cut',
				'They subtract a set amount from your file automatically',
				'They cost less to run than an additive machine does',
			],
			answer: 0,
			explanation:
		...
		},
		{
			...
			options: [
				'A machine produces better-looking results than hands do',
				'The design lives in a file, so errors are reproduced exactly',
				'The work of sanding, gluing and assembling disappears',
			],
			answer: 1,
			explanation:
