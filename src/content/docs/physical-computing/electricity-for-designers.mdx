	...
	questions={[
		{
			...
			options: [
				'The end of the pipe, where the water is used up',
				'The zero it is all measured from, and the way back',
				'The narrow section that holds the flow back',
			],
			answer: 1,
			explanation:
		...
		},
		{
			...
			options: [
				'It lights normally: an LED draws only what it needs',
				'Nothing, because an LED needs a resistor to conduct',
				'It draws far more current than it is built for and dies',
			],
			answer: 2,
			explanation:
