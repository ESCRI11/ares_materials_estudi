	...
	questions={[
		{
			q: 'What is a REPL?',
			options: [
				'The file a microcontroller runs on start-up',
				'A live prompt that reads a line you type, runs it immediately, and prints the result',
		...
		},
		{
			...
			options: [
				'It works — MicroPython converts the text automatically',
				'It fails, because input() returns text and you cannot add a number to it',
				'It waits forever',
			],
			answer: 1,
			explanation:
